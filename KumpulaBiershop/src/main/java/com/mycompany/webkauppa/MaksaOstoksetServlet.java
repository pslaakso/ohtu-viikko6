...
//		Komento ostos = new OstoksenSuoritus(nimi, osoite, luottokorttinumero, ostoskori);
		Komento ostos = komennot.ostoksenSuoritus(nimi, osoite, luottokorttinumero, ostoskori);
